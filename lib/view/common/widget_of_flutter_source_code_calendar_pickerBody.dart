 ...
 * File: /Users/bakbeom/work/hwst/lib/view/common/flutter_source_code_calinda_datePicker.dart
 * Created Date: 2021-10-02 03:22:06
 * Last Modified: 2023-02-22 22:42:54
 * Author: bakbeom
 * Modified By: bakbeom
...
class _DatePickerDialogState extends State<DatePickerDialog>
  ...
  Widget build(BuildContext context) {
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Text(
                ...
                style: TextStyle(color: AppColors.secondHintColor),
              ),
            ),
          ),
          Container(
            ...
            decoration: BoxDecoration(
                border:
                    Border(right: BorderSide(color: const Color(0xffcccccc)))),
          ),
          Expanded(
              child: InkWell(
            onTap: () => _handleOk(),
    ...
    date_picker.CalendarDatePicker calendarDatePicker() {
      return date_picker.CalendarDatePicker(
