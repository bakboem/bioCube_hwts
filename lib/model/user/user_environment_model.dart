 ...
 * Last Modified: 2023-02-26 16:59:13
 * Author: bakbeom
 * Modified By: bakbeom
...
class UserEnvironmentModel {
  ...
  UserEnvironmentModel(this.isUseBle, this.alarmType, this.isUseFace,
      this.isUseNfc, this.useType, this.rssi, this.sessionTime);
