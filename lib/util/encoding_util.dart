 ...
 * File: /Users/bakbeom/work/hwst/lib/util/encoding_util.dart
...
class EncodingUtils {
  ...
  static Map<String, dynamic> jsonStrConvert(String str) {
    var decoder = json.decoder;
    return decoder.convert(str) as Map<String, dynamic>;
  }
}
